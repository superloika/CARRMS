<template>
    <v-list shaped dense>
        <v-list-item-group color="accent lighten-3">
            ...
            <!-- <v-list-item link to="/admin/enrollment">
                <v-list-item-icon class="mr-2">
            ...
            <v-list-group no-action color="dark">
                ...
                <v-list-item link to="/admin/enrollment/elementary">
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-account-multiple</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                ...
                <v-list-item link to="/admin/enrollment/jhs">
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-account-multiple</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                        <v-list-item-title>Junior High</v-list-item-title>
                    </v-list-item-content>
                </v-list-item>
                <v-list-item link to="/admin/enrollment/shs">
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-account-multiple</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                        <v-list-item-title>Senior High</v-list-item-title>
                    </v-list-item-content>
                </v-list-item>
            </v-list-group>
            ...
            <v-list-group no-action color="dark">
                ...
                <v-list-item link to="/admin/sy">
                    ...
                    <v-list-item-content>
                        <v-list-item-title>School Year</v-list-item-title>
                    </v-list-item-content>
                </v-list-item>
            ...
            <v-list-group no-action color="dark">
                ...
                <v-list-item link to="/reports/goodmoral">
                    <v-list-item-icon class="mr-2">
                        <v-icon>mdi-file</v-icon>
                    </v-list-item-icon>
                    <v-list-item-content>
                        <v-list-item-title>Good Moral</v-list-item-title>
                    </v-list-item-content>
                </v-list-item>
            </v-list-group>
