...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    List: function List() {
      return __webpack_require__.e(/*! import() */ 6).then(__webpack_require__.bind(null, /*! ./List.vue */ "./resources/js/pages/Admin/Advisers/List.vue"));
    },
    Add: function Add() {
      return __webpack_require__.e(/*! import() */ 5).then(__webpack_require__.bind(null, /*! ./Add.vue */ "./resources/js/pages/Admin/Advisers/Add.vue"));
    }
  },
  data: function data() {
    return {};
          ...
          _c(
            ...
            [
              _c(
                "v-btn",
                {
                  attrs: { icon: "", color: "primary", title: "Advisers List" },
                  on: {
              ...
              _c(
                "v-btn",
                {
                  attrs: { icon: "", color: "primary", title: "Add Adviser" },
                  on: {
                    click: function($event) {
